...
http POST :8080/games/$GAME_ID/mark player:=1 cell=BOTTOM_LEFT
http POST :8080/games/$GAME_ID/mark player:=2 cell=TOP_RIGHT
http POST :8080/games/$GAME_ID/mark player:=1 cell=CENTER_LEFT